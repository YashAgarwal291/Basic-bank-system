...
<body style="background-color:#76c893;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed fixed-top theme" style="padding:30px;"
    ...
    <center>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%;  padding:5px 5px 5px 5px; border-radius:30px; ">
